...
Uma One-Page Website (Landing Page) luxuosa e focada em conversão, desenvolvida para a **Clínica Paixão** — especialista em Fisioterapia de elite, em estética avançada, e massoterapia.
...
*   **elfsight** - Integração de mapa interativo no card de localização.
...
*   **Diferenciais (Bento Grid)**: Apresentação de atendimento personalizado, horários, localização (com mapa real).
*   **Time de Especialistas**: Profissionais apresentados em cards com efeitos de hover elegantes.
*   **Pacotes VIP**: Com os pacotes exclusivos apresentados em um grid de proporção perfeitamente padronizada.
*   **Prova Social**: Seção de divulgação com depoimento de influenciador.
...
Desenvolvido por **[Eltind085](https://github.com/Eltind085)**.
> *Projeto assinado por **NEXUS CONVERT BR** — SITES FEITOS PARA VENDER*
